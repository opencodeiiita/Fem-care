          ...
          <Card className="p-10">
            ...
            <div className="space-y-6">
              ...
              <label className="flex items-start space-x-3 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 mt-1 text-[#E76F8A] border-gray-300 rounded focus:ring-[#E76F8A] focus:ring-2"
                />
                <span className="text-sm text-[#5A5A6A] font-inter">
                  I agree to the <button className="text-[#E76F8A] hover:underline font-semibold">Terms of Service</button> and <button className="text-[#E76F8A] hover:underline font-semibold">Privacy Policy</button>
                </span>
              </label>
