      ...
      <main className="min-h-screen bg-[#FFF9FB] flex items-center justify-center p-6">
        <Card className="w-full max-w-md p-8">
          <div className="flex items-center justify-center space-x-3">
            ...
            <span className="text-[#5A5A6A] font-medium font-inter">
              Initializing...
            </span>
          </div>
        </Card>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center space-x-3 cursor-pointer">
                  ...
                  />
                  <span className="text-sm font-medium text-[#5A5A6A] font-inter">
                    Remember me
                  </span>
                </label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button className="flex items-center justify-center px-4 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 group">
                  ...
                  <span className="text-sm font-medium text-[#5A5A6A] group-hover:text-[#1E1E2F] font-inter">
                    Google
                  </span>
                </button>
